...
public class CondenserMenu extends AbstractCondenserMenu {
	...
	protected void addIngredientSlots(IItemHandler items) {
		addSlot(new SlotItemHandler(items, AbstractCondenserBlockEntity.SLOT_INGREDIENTS_START, 27, 23));
		addSlot(new SlotItemHandler(items, AbstractCondenserBlockEntity.SLOT_INGREDIENTS_START + 1, 27, 47));
	}
}
