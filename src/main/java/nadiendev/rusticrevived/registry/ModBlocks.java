...
import nadiendev.rusticrevived.block.decor.PaintedWoodBlock;
...
import nadiendev.rusticrevived.block.farm.FlammableWoodBlocks;
...
public final class ModBlocks {
	...
	public static final DeferredBlock<StairBlock> SLATE_ROOF_STAIRS = BLOCKS.registerBlock("slate_roof_stairs",
			p -> new StairBlock(SLATE_ROOF.get().defaultBlockState(), p), () -> stoneProps());
	public static final DeferredBlock<SlabBlock> SLATE_ROOF_SLAB = BLOCKS.registerBlock("slate_roof_slab", SlabBlock::new, () -> stoneProps());
	public static final DeferredBlock<StairBlock> SLATE_BRICK_STAIRS = BLOCKS.registerBlock("slate_brick_stairs",
			p -> new StairBlock(SLATE_BRICK.get().defaultBlockState(), p), () -> stoneProps());
	public static final DeferredBlock<SlabBlock> SLATE_BRICK_SLAB = BLOCKS.registerBlock("slate_brick_slab", SlabBlock::new, () -> stoneProps());
	...
	public static final Map<DyeColor, DeferredBlock<PaintedWoodBlock>> PAINTED_WOOD = new EnumMap<>(DyeColor.class);

	static {
		for (DyeColor color : DyeColor.values()) {
			PAINTED_WOOD.put(color, BLOCKS.registerBlock("painted_wood_" + color.getSerializedName(), PaintedWoodBlock::new,
	...
	public static final DeferredBlock<IronTorchBlock> IRON_TORCH = BLOCKS.registerBlock("iron_torch", IronTorchBlock::new,
			() -> BlockBehaviour.Properties.of().mapColor(MapColor.METAL).noCollision().instabreak().lightLevel(s -> 15).sound(SoundType.METAL)
	...
	public static final DeferredBlock<Block> OLIVE_PLANKS = BLOCKS.registerBlock("olive_planks", FlammableWoodBlocks.Planks::new, () -> planksProps(MapColor.TERRACOTTA_WHITE));
	public static final DeferredBlock<Block> IRONWOOD_PLANKS = BLOCKS.registerBlock("ironwood_planks", FlammableWoodBlocks.Planks::new, () -> planksProps(MapColor.COLOR_GRAY));
	public static final DeferredBlock<RotatedPillarBlock> OLIVE_LOG = BLOCKS.registerBlock("olive_log", FlammableWoodBlocks.Log::new, () -> logProps(MapColor.TERRACOTTA_WHITE));
	public static final DeferredBlock<RotatedPillarBlock> IRONWOOD_LOG = BLOCKS.registerBlock("ironwood_log", FlammableWoodBlocks.Log::new, () -> logProps(MapColor.COLOR_GRAY));
	...
	public static final DeferredBlock<FenceBlock> OLIVE_FENCE = BLOCKS.registerBlock("olive_fence", FlammableWoodBlocks.Fence::new, () -> planksProps(MapColor.TERRACOTTA_WHITE));
	public static final DeferredBlock<FenceBlock> IRONWOOD_FENCE = BLOCKS.registerBlock("ironwood_fence", FlammableWoodBlocks.Fence::new, () -> planksProps(MapColor.COLOR_GRAY));
	public static final DeferredBlock<FenceGateBlock> OLIVE_FENCE_GATE = BLOCKS.registerBlock("olive_fence_gate",
			p -> new FlammableWoodBlocks.FenceGate(WoodType.OAK, p), () -> planksProps(MapColor.TERRACOTTA_WHITE));
	public static final DeferredBlock<FenceGateBlock> IRONWOOD_FENCE_GATE = BLOCKS.registerBlock("ironwood_fence_gate",
			p -> new FlammableWoodBlocks.FenceGate(WoodType.OAK, p), () -> planksProps(MapColor.COLOR_GRAY));
	public static final DeferredBlock<SlabBlock> OLIVE_SLAB = BLOCKS.registerBlock("olive_slab", FlammableWoodBlocks.Slab::new, () -> planksProps(MapColor.TERRACOTTA_WHITE));
	public static final DeferredBlock<SlabBlock> IRONWOOD_SLAB = BLOCKS.registerBlock("ironwood_slab", FlammableWoodBlocks.Slab::new, () -> planksProps(MapColor.COLOR_GRAY));
	public static final DeferredBlock<StairBlock> OLIVE_STAIRS = BLOCKS.registerBlock("olive_stairs",
			p -> new FlammableWoodBlocks.Stairs(OLIVE_PLANKS.get().defaultBlockState(), p), () -> planksProps(MapColor.TERRACOTTA_WHITE));
	public static final DeferredBlock<StairBlock> IRONWOOD_STAIRS = BLOCKS.registerBlock("ironwood_stairs",
			p -> new FlammableWoodBlocks.Stairs(IRONWOOD_PLANKS.get().defaultBlockState(), p), () -> planksProps(MapColor.COLOR_GRAY));
	...
	public static final DeferredBlock<Block> CARVED_OLIVE_WOOD = BLOCKS.registerBlock("carved_olive_wood", FlammableWoodBlocks.Planks::new, () -> planksProps(MapColor.TERRACOTTA_WHITE));
	/** PR #252 (Quark-style carved wood) */
	public static final DeferredBlock<Block> CARVED_IRONWOOD = BLOCKS.registerBlock("carved_ironwood", FlammableWoodBlocks.Planks::new, () -> planksProps(MapColor.COLOR_GRAY));
	...
	private static BlockBehaviour.Properties candleProps() {
		return BlockBehaviour.Properties.of().mapColor(MapColor.METAL).noCollision().strength(1.0F).lightLevel(s -> 15)
	...
	private static DeferredBlock<HerbBlock> herb(String name, HerbBlock.PlantType type, int light) {
		return BLOCKS.registerBlock(name, p -> new HerbBlock(p, type), () -> BlockBehaviour.Properties.of()
				.mapColor(MapColor.PLANT).noCollision().randomTicks().instabreak().sound(SoundType.CROP).offsetType(BlockBehaviour.OffsetType.XZ)
