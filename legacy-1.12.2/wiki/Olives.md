...
## Olive Trees ##
![](http://i.imgur.com/1szLJ4p.png)  
Olive Trees generate naturally in the overworld in forests, plains, and mountains. They do not generate in places where it can snow. The logs can be crafted into olive wood planks, which can be used to make olive wood variants of stairs, slabs, fences, fence gates, [tables](https://github.com/the-realest-stu/Rustic/wiki/Tables), and [chairs](https://github.com/the-realest-stu/Rustic/wiki/Chairs). Olive leaves drop olive saplings and olives.

## Olives ##
Olives can be eaten, but they are not very nutritious, and they inflict the player with nausea. It is better to [crush](https://github.com/the-realest-stu/Rustic/wiki/Crushing-Tub) them into Olive Oil.

## Olive Oil ##
Olive Oil can be drank, if stored in a bottle, but it inflicts the player with nausea. It is better to craft olive oil bottles with any food item, from vanilla or mods, to give the food item the "Olive Oiled" trait. Foods with this trait fill two extra hunger points (1 shank) when eaten, and they are also more saturating. Foods with the "Olive Oiled" trait are stackable, but not with un-oiled foods.