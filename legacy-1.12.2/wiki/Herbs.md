Herbs spawn naturally throughout the overworld and nether in a variety of different climates. Some Herbs are edible, and all herbs can be used in [alchemy](https://github.com/the-realest-stu/Rustic/wiki/Alchemy). The spawn frequency of herbs can be adjusted in the mod's config file. Once found, herbs can be planted and regrown.

***

## Herb Types ##
![](http://i.imgur.com/LTfijcc.png)  
+ Aloe Vera
