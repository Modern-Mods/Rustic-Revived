...
public class TomatoEntity extends ThrowableItemProjectile {
	...
	public TomatoEntity(Level level, LivingEntity shooter, ItemStack stack) {
		super(ModEntities.TOMATO.get(), shooter, level, stack);
	}
	...
	private ParticleOptions getParticle() {
		...
		return new ItemParticleOption(ParticleTypes.ITEM, item.isEmpty()
				? new ItemStackTemplate(ModItems.TOMATO.get())
