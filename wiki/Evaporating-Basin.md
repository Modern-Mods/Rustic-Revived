...
[CraftTweaker](CraftTweaker-Support.md) and [KubeJS](KubeJS-Support.md) support is available so that modpack makers can add and remove recipes.
...
## Recipes ##
+ [Ironberry Juice](Ironberries.md) -> [Tiny Pile of Iron Dust](Materials.md)
+ Golden Apple Juice -> [Gold Dust](Materials.md)