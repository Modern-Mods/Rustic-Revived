...
public final class RusticRecipeSchemas {
	public static final RecipeComponentType<BrewingRecipe.QualityMode> QUALITY_COMPONENT =
			EnumComponent.of(RusticRevived.id("brewing_quality"), BrewingRecipe.QualityMode.class);
	...
	public static final RecipeKey<SizedFluidIngredient> EVAPORATING_FLUID = SizedFluidIngredientComponent.FLAT.inputKey("fluid");
	...
	public static final RecipeKey<List<Ingredient>> CONDENSER_INGREDIENTS = IngredientComponent.INGREDIENT.instance().asList().inputKey("ingredients");
	...
	public static final RecipeKey<SizedFluidIngredient> CONDENSER_FLUID = SizedFluidIngredientComponent.FLAT.inputKey("fluid").defaultOptional();
