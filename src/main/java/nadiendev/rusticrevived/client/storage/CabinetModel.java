...
/**
 * Cabinet geometry (legacy ModelCabinet / ModelCabinetDouble, same boxes and UVs); its state is the
 * door (and handle) rotation around the hinge, in radians. Coordinates use the legacy y-down model
 * space; {@link CabinetRenderer#applyTransform} applies the legacy transform.
 */
public class CabinetModel extends Model<Float> {
	...
	@Override
	public void setupAnim(Float doorAngle) {
		super.setupAnim(doorAngle);
		door.yRot = doorAngle;
