...
public class AlmanacScreen extends Screen {
	...
	public static final Identifier BOOK_TEXTURE = RusticRevived.id("textures/gui/book/book.png");
	...
	public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
		...
		graphics.blit(RenderPipelines.GUI_TEXTURED, BOOK_TEXTURE, guiLeft, guiTop, 0, 0, WIDTH, HEIGHT, TEXTURE_SIZE, TEXTURE_SIZE);
	}
	...
	/** Drawn over the world with the transparent in-game background. */
	@Override
	...
	public void drawTitle(GuiGraphicsExtractor graphics, String translationKey, int x, int y) {
		Component title = Component.translatable(translationKey).withStyle(ChatFormatting.UNDERLINE, ChatFormatting.BOLD);
		graphics.text(font, title, x - font.width(title) / 2, y, TEXT_COLOR, false);
	}
