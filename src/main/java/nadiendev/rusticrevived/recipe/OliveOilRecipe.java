...
public class OliveOilRecipe extends CustomRecipe {
	public static final OliveOilRecipe INSTANCE = new OliveOilRecipe();

	private OliveOilRecipe() {
	}
	...
	public static boolean canBeOiled(ItemStack stack) {
		if (!stack.has(DataComponents.FOOD) || stack.has(ModDataComponents.OLIVE_OILED) || stack.is(ModTags.Items.OLIVE_OIL_BLACKLIST)) {
			return false;
		}
	...
	@Override
	public RecipeSerializer<OliveOilRecipe> getSerializer() {
