...
public final class RusticConfig {
	...
	public static final class Common {
		...
		private Map<ResourceLocation, Integer> amplifierCache;
		 ...
		 */
		public int getWildberryMaxAmplifier(ResourceLocation effectId) {
	...
	private static boolean isAmplifierOverride(Object o) {
		...
		if (split.length != 2 || ResourceLocation.tryParse(split[0].trim()) == null) return false;
		try {
