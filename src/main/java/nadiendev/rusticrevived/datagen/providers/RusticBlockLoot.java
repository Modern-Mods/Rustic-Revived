...
/**
 * Block loot tables. Every Rustic block must have one (liquid blocks excepted). Each subsystem
 * generates its own tables from {@code datagen.providers.parts}; the protected vanilla helpers are
 * re-exposed publicly here.
 */
