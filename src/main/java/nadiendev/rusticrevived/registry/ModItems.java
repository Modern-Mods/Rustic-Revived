...
public final class ModItems {
	...
	public static final DeferredItem<BannerPatternItem> ERIS_BANNER_PATTERN = ITEMS.registerItem("eris_banner_pattern",
			p -> new BannerPatternItem(ModTags.BannerPatterns.ERIS, p), new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON));
	...
	public static final DeferredItem<RusticFoodItem> OLIVES = ITEMS.registerItem("olives", p -> new RusticFoodItem(p, 24, null, null),
			new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationModifier(0.4F)
					.effect(() -> new MobEffectInstance(MobEffects.CONFUSION, 200, 1, false, false), 0.95F).build()));
	public static final DeferredItem<RusticFoodItem> IRONBERRIES = ITEMS.registerItem("ironberries", p -> new RusticFoodItem(p, 16, (stack, level, player) -> {
		int duration = 15 * 20;
	...
	}, null), new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.4F).alwaysEdible().build()));
	public static final DeferredItem<TomatoItem> TOMATO = ITEMS.registerItem("tomato", TomatoItem::new,
			new Item.Properties().food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.4F).build()));
	public static final DeferredItem<RusticFoodItem> CHILI_PEPPER = ITEMS.registerItem("chili_pepper", p -> new RusticFoodItem(p, -1, (stack, level, player) -> {
		player.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 400));
		if (RAND.nextInt(24) == 0) {
			player.hurt(level.damageSources().onFire(), 1.0F);
		}
	}, null), new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationModifier(0.4F).alwaysEdible().build()));
	public static final DeferredItem<RusticFoodItem> GHOST_PEPPER = ITEMS.registerItem("ghost_pepper", p -> new RusticFoodItem(p, -1, (stack, level, player) -> {
		player.hurt(level.damageSources().onFire(), 2.0F);
		player.addEffect(new MobEffectInstance(ModEffects.FIRE_POWER, 1200, 0));
	}, "tooltip.rusticrevived.ghost_pepper"), new Item.Properties().food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.7F).alwaysEdible().build()));
	public static final DeferredItem<RusticFoodItem> WILDBERRIES = ITEMS.registerItem("wildberries", p -> new RusticFoodItem(p, 16, null, null),
			new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.5F).build()));
	public static final DeferredItem<RusticFoodItem> GRAPES = ITEMS.registerItem("grapes", p -> new RusticFoodItem(p, 16, null, null),
	...
	public static final DeferredItem<StakeCropSeedItem> TOMATO_SEEDS = ITEMS.registerItem("tomato_seeds",
			p -> new StakeCropSeedItem(ModBlocks.TOMATO_CROP.get(), p), new Item.Properties());
	public static final DeferredItem<StakeCropSeedItem> CHILI_PEPPER_SEEDS = ITEMS.registerItem("chili_pepper_seeds",
			p -> new StakeCropSeedItem(ModBlocks.CHILI_CROP.get(), p), new Item.Properties());

	// ================================================================ herbs (roots that are planted and eaten)

	public static final DeferredItem<ItemNameBlockItem> CLOUDSBLUFF = ITEMS.registerItem("cloudsbluff",
			p -> new ItemNameBlockItem(ModBlocks.CLOUDSBLUFF.get(), p), new Item.Properties().food(new FoodProperties.Builder().nutrition(2)
					.saturationModifier(0.2F).alwaysEdible().effect(() -> new MobEffectInstance(MobEffects.LEVITATION, 400), 1.0F).build()));
	public static final DeferredItem<ItemNameBlockItem> CORE_ROOT = ITEMS.registerItem("core_root",
			p -> new ItemNameBlockItem(ModBlocks.CORE_ROOT.get(), p), new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.3F).build()));
	public static final DeferredItem<ItemNameBlockItem> GINSENG = ITEMS.registerItem("ginseng",
			p -> new ItemNameBlockItem(ModBlocks.GINSENG.get(), p), new Item.Properties().food(new FoodProperties.Builder().nutrition(2).saturationModifier(0.3F).build()));
	public static final DeferredItem<ItemNameBlockItem> MARSH_MALLOW = ITEMS.registerItem("marsh_mallow",
			p -> new ItemNameBlockItem(ModBlocks.MARSH_MALLOW.get(), p), new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationModifier(0.3F).build()));
	...
	static {
		...
		ITEMS.registerItem("olive_door", p -> new DoubleHighBlockItem(ModBlocks.OLIVE_DOOR.get(), p));
		ITEMS.registerItem("ironwood_door", p -> new DoubleHighBlockItem(ModBlocks.IRONWOOD_DOOR.get(), p));
		// agriculture
		...
		// storage & bees
		ITEMS.registerItem("vase", p -> new VaseItem(ModBlocks.VASE.get(), p));
		...
		ITEMS.registerItem("liquid_barrel", p -> new LiquidBarrelItem(ModBlocks.LIQUID_BARREL.get(), p));
	}
