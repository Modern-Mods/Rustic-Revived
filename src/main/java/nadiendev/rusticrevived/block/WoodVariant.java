...
public enum WoodVariant implements StringRepresentable {
	...
	public ResourceLocation planksTexture() {
		return switch (this) {
			case OLIVE -> ResourceLocation.fromNamespaceAndPath(nadiendev.rusticrevived.RusticRevived.NAMESPACE, "block/planks_olive");
			case IRONWOOD -> ResourceLocation.fromNamespaceAndPath(nadiendev.rusticrevived.RusticRevived.NAMESPACE, "block/planks_ironwood");
			default -> ResourceLocation.withDefaultNamespace("block/" + name + "_planks");
		};
	}
}
